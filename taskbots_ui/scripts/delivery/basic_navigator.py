...
class BasicNavigator(Node):
    def __init__(self):
        ...
        self.model_name = "navigation_bot_09"
        ...
        # set_model_state_client and get_model_state_client are client objects created using the create_client() method of the rclpy library. These client objects are used to communicate with the services provided by the Gazebo simulator.
        # set_model_state_client is used to set the state of a model in Gazebo, such as its position, orientation, and velocity. It takes in a SetModelState service request, which includes the name of the model and its desired state.
        # get_model_state_client is used to retrieve the state of a model in Gazebo, such as its position, orientation, and velocity. It takes in a GetModelState service request, which includes the name of the model to retrieve.
        # Both of these clients allow your code to interact with the Gazebo simulator by sending service requests and receiving responses. By using these clients, you can control the simulation and obtain information about the objects in the environment.
